<template>
    <Motion
        ...
        class="`m-0 mx-auto rounded-full relative font-black text-center cursor-pointer origin-center`"
    ...
    >
        <span
            ...
            :key="i"
            class="absolute inline-block inset-0 transition-all duration-500 ease-[cubic-bezier(0,0,0,1)]"
            :style="{
