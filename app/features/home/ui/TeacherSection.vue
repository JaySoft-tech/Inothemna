                    ...
                    >
                        ...
                        >
                            <img
                                ...
                                :class="{
                                    'opacity-0 scale-105':
                                        openTeacher === getTeacherIndex(index),
                                }"
                            />
                ...
                >
                    ...
                    >
                        <div
                            ...
                            @click="
                                toggleTeacherInfo(getTeacherIndexMobile(index))
                            "
                        >
                            <img
                            ...
                            <transition name="teacher-info">
                                ...
                                >
                                    <h3
                                        class="font-shantell font-medium text-[15px] mb-[6px]"
                                    >
                                        {{ teacher!.name }}
                                    </h3>
                                    <p
                                        class="font-outfit font-semibold text-[9px] mb-[10px]"
                                    >
                                        {{ teacher!.experience }}
                                    </p>
                                    <p
...
const getVisibleTeachers = () => {
    return Array.from(
        { length: 4 },
        (_, i) =>
            teachers.value[(currentSlide.value + i) % teachers.value.length]
    );
};
